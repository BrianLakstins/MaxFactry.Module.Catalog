// <copyright file="MaxCatalogIdRepositoryProvider.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Catalog.DataLayer.Provider
{
    ...
    /// </summary>
    public class MaxCatalogIdRepositoryProvider : MaxFactry.Base.DataLayer.Provider.MaxStorageWriteRepositoryDefaultProvider
    {
    }
}
