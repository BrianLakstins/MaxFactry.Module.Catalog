// <copyright file="MaxManufacturerDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Catalog.DataLayer
{
    ...
    /// </summary>
    public class MaxManufacturerDataModel : MaxFactry.Base.DataLayer.MaxBaseIdDataModel
    {
        /// <summary>
        /// Name of the catalog
        /// </summary>
        ...
        /// <summary>
        /// Options associated with this manufacturer.
        /// </summary>
        public readonly string OptionList = "OptionList";

        /// <summary>
        /// Initializes a new instance of the MaxManufacturerDataModel class
        /// </summary>
        public MaxManufacturerDataModel()
        {
            this.SetDataStorageName("MaxCatalogManufacturer");
