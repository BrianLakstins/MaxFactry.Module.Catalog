// <copyright file="MaxVendorEntity.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Catalog.BusinessLayer
{
    ...
    public class MaxVendorEntity : MaxFactry.Base.BusinessLayer.MaxBaseIdEntity
    {
		/// <summary>
        /// Initializes a new instance of the MaxVendorEntity class
		/// </summary>
		/// <param name="loData">object to hold data</param>
		public MaxVendorEntity(MaxData loData) : base(loData)
		{
		}
        ...
        public MaxVendorEntity(Type loDataModelType)
        ...
        /// </summary>
        protected MaxVendorDataModel DataModel
        {
            get
            {
                return (MaxVendorDataModel)MaxDataLibrary.GetDataModel(this.DataModelType);
            }
        }

        public static MaxVendorEntity Create()
        {
            return MaxBusinessLibrary.GetEntity(
                typeof(MaxVendorEntity),
                typeof(MaxVendorDataModel)) as MaxVendorEntity;
        }
