// <copyright file="MaxOrderShippingAddressEntity.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Catalog.BusinessLayer
{
    ...
    public class MaxOrderShippingAddressEntity : MaxFactry.Base.BusinessLayer.MaxBaseUSPostalAddressEntity
    {
        /// <summary>
        /// Initializes a new instance of the MaxOrderShippingAddressEntity class
        /// </summary>
        /// <param name="loData">object to hold data</param>
        public MaxOrderShippingAddressEntity(MaxData loData)
            : base(loData)
        {
        }
        ...
        public MaxOrderShippingAddressEntity(Type loDataModelType)
        ...
        /// </summary>
        protected MaxOrderShippingAddressDataModel DataModel
        {
            get
            {
                return (MaxOrderShippingAddressDataModel)MaxDataLibrary.GetDataModel(this.DataModelType);
            }
        }

        public static MaxOrderShippingAddressEntity Create()
        {
            return MaxBusinessLibrary.GetEntity(
                typeof(MaxOrderShippingAddressEntity),
                typeof(MaxOrderShippingAddressDataModel)) as MaxOrderShippingAddressEntity;
        }
