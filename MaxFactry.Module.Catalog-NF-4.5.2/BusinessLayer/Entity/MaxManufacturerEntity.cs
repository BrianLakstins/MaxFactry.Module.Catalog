// <copyright file="MaxManufacturerEntity.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Catalog.BusinessLayer
{
    ...
    public class MaxManufacturerEntity : MaxFactry.Base.BusinessLayer.MaxBaseIdEntity
    {
		/// <summary>
        /// Initializes a new instance of the MaxManufacturerEntity class
		/// </summary>
		/// <param name="loData">object to hold data</param>
		public MaxManufacturerEntity(MaxData loData) : base(loData)
		{
		}
        ...
        public MaxManufacturerEntity(Type loDataModelType)
        ...
        /// </summary>
        protected MaxManufacturerDataModel DataModel
        {
            get
            {
                return (MaxManufacturerDataModel)MaxDataLibrary.GetDataModel(this.DataModelType);
            }
        }

        public static MaxManufacturerEntity Create()
        {
            return MaxBusinessLibrary.GetEntity(
                typeof(MaxManufacturerEntity),
                typeof(MaxManufacturerDataModel)) as MaxManufacturerEntity;
        }
