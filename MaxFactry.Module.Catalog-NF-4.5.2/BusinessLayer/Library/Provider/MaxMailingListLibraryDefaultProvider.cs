// <copyright file="MaxMailingListLibraryDefaultProvider.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.Module.Catalog.BusinessLayer.Provider
{
    ...
    public class MaxMailingListLibraryDefaultProvider : MaxFactry.Core.MaxProvider, IMaxMailingListLibraryProvider
    {
        public virtual bool Subscribe(string lsList, string lsEmail, MaxIndex loMetaIndex)
        {
            bool lbR = false;
